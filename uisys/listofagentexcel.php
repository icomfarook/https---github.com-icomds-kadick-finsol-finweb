...
$objPHPExcel = new PHPExcel();
		...
		$heading = array("Agent Code","Agent Name","Login Name","Parent Name","Parent Type","State","Local Government","Active","Block Status");
		$headcount = 9;
