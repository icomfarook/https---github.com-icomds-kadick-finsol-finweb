<?php
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if(isset($data -> operation) && $data -> operation == 'REGISTRATION') {
			...
			error_log("signature = ".$data->signature.", firstName = ".$data->registration->firstName.", lastName = ".$data->registration->lastName.", bvn = ".$data->registration->bvn);
			...
			error_log("idName = ".$data->registration->idName.", locLatitude = ".$data->registration->locLatitude.", locLongitude = ".$data->registration->locLongitude);
			    ...
			    && isset($data->registration->dob) && !empty($data->registration->dob)
			    && isset($data->registration->gender) && !empty($data->registration->gender)
			   ...
			   // && isset($data->registration->businessFileType) && !empty($data->registration->businessFileType)
				...
				$businessType = $data->registration->businessType;
