	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST') {
		...
		if ( isset($data -> userId ) && !empty($data -> userId) 
			...
			if ( $local_signature == $signature ){	
                		...
                		$insert_mpos_debug_query = "INSERT INTO mpos_debug_dump (mpos_debug_dump_id, user_id, party_code, party_type, message, pic_point, message_type, date_time) VALUES(0, $userId, '$partyCode', '$partyType', '$message', $picPoint, '$messageType', now())";
