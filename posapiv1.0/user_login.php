															...
															if ( $user_sec_check_result ) {
																...
																if($user_sec_check_count > 0) {														
																	...
																	if($login_allow == "Y") {
																		...
																		$user_pos_config_query = "select terminal_id, nibss_key1, nibss_key2, nibss_server_ip, nibss_server_port, app_timeout, imei, status, debug_flag, mpos_simulate, control_field1, control_field2, control_field3, control_field4, control_field5, control_field6, ifnull(pos_pin, '') as pos_pin, ifnull(pay_min_limit, 0) as pay_min_limit, ifnull(pay_max_limit, 1000000) as pay_max_limit, ifnull(cashin_min_limit, 0) as cashin_min_limit, ifnull(cashin_max_limit, 500000) as cashin_max_limit, ifnull(cashout_min_limit, 0) as cashout_min_limit, ifnull(cashout_max_limit, 500000) as cashout_max_limit, ifnull(recharge_min_limit, 0) as recharge_min_limit, ifnull(recharge_max_limit, 10000) as recharge_max_limit, ifnull(flexi_rate,'N') as flexi_rate from user_pos where user_id = ".$user_id;
