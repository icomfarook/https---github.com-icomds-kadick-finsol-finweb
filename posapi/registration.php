			    ...
			    if ($select_bvn_result) {
                        ...
                        if ( $select_bvn_count == 0 ) {
                            ...
                            if($pre_application_id > 0) {
                                ...
                                $insert_main_query = "INSERT into pre_application_info (pre_application_info_id, country_id, bvn, outlet_name, address1, local_govt_id, state_id, mobile_no, email, language_id, contact_person_name, contact_person_mobile, loc_latitude, loc_longitude, comments, status, create_user, create_time) values ($pre_application_id, $countryId, '$bvn', '$outletName', '$address', $localGovtId, $stateId, '$mobile', '$email', $language_id, '$contactName', '$mobile', left('$latitude', 10), left('$longitude', 10), '$comments', 'E', 6, now())";
