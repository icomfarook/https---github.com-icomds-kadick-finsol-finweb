...
define ("EVD_FIXED_SERVER_URL","http://localhost:80/finweb/api/fixedrecharge.php");
define ("EVD_SERVER_URL","http://localhost:80/finweb/api/flexirecharge.php");
define ("EVD_SERVER_9M_URL","http://localhost:80/finweb/api/flexirecharge.php");

define ("FINWEB_SERVER_CASHOUT_CARD_TREATMENT_URL","http://localhost:80/finweb/posapiv2.0/cashout_mpos_order_update.php");

//Local PHP Stub Responer 
define ("FINAPI_SERVER_CASHIN_URL","http://localhost:80/finweb/api/cashinpost.php");
define ("FINAPI_SERVER_CASHOUT_URL","http://localhost:80/finweb/api/cashoutpost.php");
define ("FINAPI_SERVER_BALANCE_ENQUIREY_URL","http://localhost:80/finweb/api/balanceenquiry.php");
define ("FINAPI_SERVER_BVN_ENQUIREY_URL","http://localhost:80/finweb/api/bvnenquiry.php");
define ("FINAPI_SERVER_TRANSACTION_ENQUIREY_URL","http://localhost:80/finweb/api/transactionenquiry.php");
define ("FINAPI_SERVER_GENERATE_OTP_URL","http://localhost:80/finweb/api/generateotp.php");
define ("FINAPI_SERVER_CNAME_URL","http://localhost:80/finweb/api/cname.php");
define ("FINAPI_SERVER_OTHER_BANK_TRANSFER_URL","http://localhost:80/finweb/api/obt.php");
define ("FINAPI_SERVER_TIER_AC1_URL","http://localhost:80/finweb/api/t1accstatuspost.php");
define ("FINAPI_SERVER_TIER_AC1_CREATE_URL","http://localhost:80/finweb/api/createt1accpost.php");
define ("FINAPI_SERVER_FLEXI_API_URL","http://localhost:80/flexiapi/ws.api/flexisale");
define ("FINAPI_SERVER_NAME_ENQUIRY_URL","http://localhost:80/finweb/api/nnenquiry.php");
define ("FINAPI_SERVER_BVN_CHECK_URL","http://localhost:80/KADICK-FINSOL-FINWEB/api/bvn_check.php");



//PayAttitude Cashout Phone
define ("FINAPI_SERVER_CASHOUT_PHONE_URL","http://localhost:80/finweb/api/cashoutphonepost.php");
//define ("FINAPI_SERVER_CASHOUT_PHONE_URL","http://localhost:8080/finsol/fwbank.api/ptpaybyphone");
define ("FINAPI_SERVER_CASHOUT_PHONE_TSQ_URL","http://localhost:80/finweb/api/cashoutphonetsqpost.php");
//define ("FINAPI_SERVER_CASHOUT_PHONE_TSQ_URL","http://localhost:8080/finsol/fwbank.api/pttsq");


//Coral Pay Cashout USSD
define ("FINAPI_SERVER_CASHOUT_USSD_GENREF_URL","http://localhost:80/finweb/api/cashoutussdpost.php");
//define ("FINAPI_SERVER_CASHOUT_USSD_GENREF_URL","http://localhost:8080/finsolbp/cpay.api/ptpaybyphone");
define ("FINAPI_SERVER_CASHOUT_USSD_TSQ_URL","http://localhost:80/finweb/api/cashoutussdtsqpost.php");
//define ("FINAPI_SERVER_CASHOUT_USSD_TSQ_URL","http://localhost:8080/finsolbp/cpay.api/pttsq");


//PayAnt Bill Pay
define ("BPAPI_PAYANT_SERVER_VERIFY_CUSTOMER_URL","http://localhost:80/finweb/api/payantverifycustomer.php");
//define ("BPAPI_PAYANT_SERVER_VERIFY_CUSTOMER_URL","http://localhost:8080/finsolbp/bppayant.api/verifycustomer");
define ("BPAPI_PAYANT_SERVER_VERIFY_TV_CUSTOMER_URL","http://localhost:80/finweb/api/payantverifytvcustomer.php");
//define ("BPAPI_PAYANT_SERVER_VERIFY_TV_CUSTOMER_URL","http://localhost:8080/finsolbp/bppayant.api/verifytvcustomer");
define ("BPAPI_PAYANT_SERVER_BILL_PAYMENT_URL","http://localhost:80/finweb/api/payantbillpayment.php");
//define ("BPAPI_PAYANT_SERVER_BILL_PAYMENT_URL","http://localhost:8080/finsolbp/bppayant.api/billpayment");
define ("BPAPI_PAYANT_SERVER_TV_BILL_PAYMENT_URL","http://localhost:80/finweb/api/payanttvbillpayment.php");
//define ("BPAPI_PAYANT_SERVER_TV_BILL_PAYMENT_URL","http://localhost:8080/finsolbp/bppayant.api/billpaymenttv");
define ("BPAPI_PAYANT_SERVER_BILL_PAYMENT_EDUCATION_URL","http://localhost:80/finweb/api/payantbillpaymenteducation.php");
//define ("BPAPI_PAYANT_SERVER_BILL_PAYMENT_EDUCATION_URL","http://localhost:8080/finsolbp/bppayant.api/billpaymentedu");
define ("BPAPI_PAYANT_SERVER_WALLET_BALANCE_URL","http://localhost:80/finweb/api/bpwalletbalance.php");
//define ("BPAPI_PAYANT_SERVER_WALLET_BALANCE_URL","http://localhost:8080/finsolbp/bppayant.api/walletbalance");

//Opay Betting Pay
define ("BPAPI_OPAY_SERVER_VERIFY_BETTING_CUSTOMER_URL","http://localhost:80/finweb/api/opayverifybettingcustomer.php");
//define ("BPAPI_OPAY_SERVER_VERIFY_BETTING_CUSTOMER_URL","http://localhost:8080/finsolbp/opay.api/validate");
define ("BPAPI_OPAY_SERVER_PAYMENT_BETTING_CUSTOMER_URL","http://localhost:80/finweb/api/opaybettingpayment.php");
//define ("BPAPI_OPAY_SERVER_PAYMENT_BETTING_CUSTOMER_URL","http://localhost:8080/finsolbp/opay.api/payment");
define ("BPAPI_OPAY_SERVER_WALLET_BALANCE_URL","http://localhost:80/finweb/api/opaywalletbalance.php");

//NIBSS Bill Pay
define ("BPAPI_SERVER_PRODUCT_FORM_VALIDATE_URL","http://localhost:80/finweb/api/bpvalidate.php");
define ("BPAPI_SERVER_PAYMENT_CONFIRM_URL","http://localhost:80/finweb/api/bpconfirm.php");
define ("BPAPI_SERVER_PAYMENT_RECEIPT_URL","http://localhost:80/finweb/api/bpreceipt.php");

define ("SANEFAPI_SERVER_ACCOUNT_OPEN","http://localhost:80/finweb/api/sanef_acc_open.php");
define ("SANEFAPI_SERVER_WALLET_OPEN","http://localhost:80/finweb/api/sanef_wallet_open.php");
define ("SANEFAPI_SERVER_ACCOUNT_STATUS","http://localhost:80/finweb/api/sanef_acc_status.php");
define ("SANEFAPI_SERVER_CARD_TRIGGER_OTP","http://localhost:80/finweb/api/sanef_trigger_otp.php");
define ("SANEFAPI_SERVER_CARD_CARD_LINK","http://localhost:80/finweb/api/sanef_card_link.php");
define ("SANEFAPI_SERVER_CREATE_AGENT","http://localhost:80/finweb/api/sanef_create_agent.php");
define ("SANEFAPI_SERVER_UPDATE_AGENT","http://localhost:80/finweb/api/sanef_update_agent.php");
define ("SANEFAPI_SERVER_DETAIL_AGENT","http://localhost:80/finweb/api/sanef_detail_agent.php");
...
define ("FUND_TRANSFER_URL","http://localhost:80/finweb/posapi/nfundtransfer.php");
define ("LIVE_CASHOUT_MCASH_TRIGGER_URL","http://localhost:80/finweb/posapi/mcash_trigger.php");
define ("LIVE_CASHOUT_MCASH_SMS_NOTIFICATION_URL","http://localhost:80/finsol/srssms.api/sendSms");
...
//define ("PTSP_POSVAS_HOST_URL","http://192.168.2.104:80/finweb/");
