					...
					if($typeDetail == false) {
						if($agentName == "ALL"){
							if($agentDetail == false) {
								...
								$headcount = 4;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count,concat(d.name) as State,(select name from local_govt_list where local_govt_id=c.local_govt_id) as local  FROM bp_service_order a, bp_request b,agent_info c,state_list d WHERE a.user_id = c.user_id and c.state_id=d.state_id and a.bp_service_order_no = b.order_no and b.status = 'S' and date(a.date_time) between '$startDate' and '$endDate' group by date(a.date_time),State,local order by date(a.date_time)";
							}
							else {
						...
						if($agentName == "ALL"){
							...
							$headcount = 5;
							$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type',concat(e.name) as State,(select name from local_govt_list where local_govt_id=d.local_govt_id) as local FROM bp_service_order a, bp_request b, service_feature c,agent_info d,state_list e WHERE a.user_id = d.user_id and d.state_id = e.state_id and a.bp_service_order_no = b.order_no and b.status = 'S' and a.service_feature_code = c.feature_code and date(a.date_time) between '$startDate' and '$endDate' group by a.service_feature_code, date(a.date_time) ,State,local order by a.service_feature_code, date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
								$headcount = 6;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type', concat(b.agent_name,' [',ifNULL((select champion_name FROM champion_info WHERE champion_code = b.parent_code), 'Self'),']') as agent,concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id = e.state_id and a.bp_service_order_no = d.order_no and d.status = 'S' and a.service_feature_code = c.feature_code and date(a.date_time) between '$startDate' and '$endDate' and a.user_id = b.user_id group by b.parent_code,local, a.service_feature_code, agent, date(a.date_time),State order by a.service_feature_code, agent, date(date_time)";
							}
						}
						else {
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount = 5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_fe5ture_code, ' - ', c.feature_description) as 'Order Type',concat(e.name) as State ,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id=e.state_id and a.bp_service_order_no = d.order_no and d.status = 'S' and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and date(a.date_time) between '$startDate' and '$endDate'   group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
								$headcount =6;
					...
					if($typeDetail == false) {
						...
						if($agentName == "ALL"){
							...
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount = 5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type', concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id = e.state_id  and a.bp_service_order_no = d.order_no and d.status = 'S' and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and a.service_feature_code = '$type' and date(a.date_time) between '$startDate' and '$endDate'   group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount = 6;
					...
					if($typeDetail == false) {
						...
						if($agentName == "ALL"){
							...
							$headcount = 5;
								...
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount = 5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type', concat(b.agent_name,' [',ifNULL((select champion_name FROM champion_info WHERE champion_code = b.parent_code), 'Self'),']') as agent,concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id = e.state_id and a.bp_service_order_no = d.order_no and d.status = 'S' and  e.state_id=$state  and a.service_feature_code = c.feature_code and date(a.date_time) between '$startDate' and '$endDate' and a.user_id = b.user_id group by b.parent_code,local,   State  ,a.service_feature_code, agent, date(date_time) order by a.service_feature_code, agent, date(date_time)";
							}
						}
						else {
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount =5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type',concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id=e.state_id and a.bp_service_order_no = d.order_no and d.status = 'S' and  e.state_id=$state and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and date(a.date_time) between '$startDate' and '$endDate' group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount =6;
					...
					if($typeDetail == false) {
						...
						if($agentName == "ALL"){
							...
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount = 5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type', concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id = e.state_id  and a.bp_service_order_no = d.order_no and d.status = 'S' and  e.state_id=$state and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and a.service_feature_code = '$type' and date(a.date_time) between '$startDate' and '$endDate' group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount = 5;
					...
					if($typeDetail == false) {
						...
						if($agentName == "ALL"){
							...
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount =5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type',concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id=e.state_id and a.bp_service_order_no = d.order_no and d.status = 'S' and  b.state_id = '$state' and b.local_govt_id = '$local_govt_id' and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and date(a.date_time) between '$startDate' and '$endDate'   group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount =6;
					...
					if($typeDetail == false) {
						...
						if($agentName == "ALL"){
							...
							if($agentDetail == false) {
								$heading = array("Date","Count","Order Type","State","Local Government");
							$headcount = 5;
								$query ="SELECT date(a.date_time) as Date, count(*) as Count, concat(a.service_feature_code, ' - ', c.feature_description) as 'Order Type', concat(e.name) as State,(select name from local_govt_list where local_govt_id=b.local_govt_id) as local FROM bp_service_order a, agent_info b, service_feature c, bp_request d,state_list e WHERE b.state_id = e.state_id  and a.bp_service_order_no = d.order_no and d.status = 'S' and  b.state_id = '$state' and b.local_govt_id = '$local_govt_id' and a.service_feature_code = c.feature_code and b.agent_code = '$agentName' and a.user_id = b.user_id and a.service_feature_code = '$type' and date(a.date_time) between '$startDate' and '$endDate'   group by  State,local  ,a.service_feature_code, date(a.date_time) order by a.service_feature_code,date(a.date_time)";
							}
							else {
								$heading = array("Date","Count","Order Type","Agent Name","State","Local Government");
							$headcount = 6;
