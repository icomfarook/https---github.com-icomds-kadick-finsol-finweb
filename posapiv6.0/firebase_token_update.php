				...
				if ( $local_signature == $signature ){	
					...
					if ($result) {
						...
						if($count > 0) {
							...
							$insert_query = "INSERT INTO installed_user (imei, firebase_token, status, user_id, create_time) VALUES ('$imei', '$fbToken', 'I', $userId, now())";
				...
				if ( $local_signature == $signature ){	
					...
					if ($result) {
						...
						if($count > 0) {
							...
							$insert_query = "INSERT INTO installed_user (imei, firebase_token, status, user_id, create_time) VALUES ('$imei', '$fbToken', 'O', $userId, now())";
							error_log("insert_query = ".$insert_query);
							$insert_result = mysqli_query($con, $insert_query);
							if( $insert_result ) {
				...
				if ( $local_signature == $signature ){	
					...
					if ($result) {
						...
						if($count > 0) {
							...
							$insert_query = "INSERT INTO installed_user (imei, firebase_token, status, user_id, create_time) VALUES ('$imei', '$fbToken', 'R', $userId, now())";
							error_log("insert_query = ".$insert_query);
							$insert_result = mysqli_query($con, $insert_query);
							if( $insert_result ) {
				...
				if ( $local_signature == $signature ){	
					...
					if ($result) {
						...
						if($count > 0) {
							...
							$insert_query = "INSERT INTO installed_user (imei, firebase_token, status, user_id, create_time) VALUES ('$imei', '$fbToken', 'L', $userId, now())";
							error_log("insert_query = ".$insert_query);
							$insert_result = mysqli_query($con, $insert_query);
							if( $insert_result ) {
