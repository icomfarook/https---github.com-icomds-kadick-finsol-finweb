		...
		if(isset($data -> operation) && $data -> operation == 'PAYMENT_BANK_DEPOSIT') {
			error_log("inside operation == PAYMENT_BANK_DEPOSIT method");
				...
				if ( $local_signature == $signature ) {
					...
					$refCheck="Select payment_reference_no from payment_receipt where payment_reference_no = '$paymentReferenceNo'";
                    ...
                    if( $payment_receipt_id > 0 )  {
                        ...
                        $response["message"] = "The Reference Number is alreday Exists";
                        $response["signature"] = $server_signature;
					}
				}else {
					// Invalid Singature
