...
$objPHPExcel = new PHPExcel();
	...
	if($creteria == "BT") {
		...
		error_log($query);
		$heading = array("Order No","Order Type","Agent","Request Amount","Total Amount","Reference", "Date Time","Update Time","Agent Charge","Ams Charge","Stamp Charge","Partner Charge","Other Charge","Total Charge");
		$headcount = 14;
