					...
					if($agentDetail == false) {
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {		
									$heading = array("Date","Count", "Order Type", "Parent", "Sub Agent Name");
									$headcount = 5;								
					...
					if($agentDetail == false) {
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {
									$heading = array("Date","Count", "Order Type", "Sub Agent Name");
									$headcount = 4;
					...
					if($agentDetail == false) {
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {
									$heading = array("Date","Count", "Sub Agent Name");
									$headcount = 3;
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {
									$heading = array("Date","Count", "Parent", "Sub Agent Name");
									$headcount = 4;
					...
					if($agentDetail == false) {
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {
									$heading = array("Date","Count",  "Order Type", "Sub Agent");
									$headcount = 4;
						...
						if($creteria == "S") {
							if($subAgentDetail == false) {
								...
								if($subAgentName == "ALL") {
									$heading = array("Date","Count", "Order Type", "Parent", "Sub Agent");
									$headcount = 5;
