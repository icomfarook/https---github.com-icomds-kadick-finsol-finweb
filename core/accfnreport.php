...
<div ng-controller='AccfnReportCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!rptaccfin"><?php echo FINANCIAL_REPORT_MAIN_HEADING1; ?></a></li>
			<li><a href="#!rptaccfin">Account Financial Report</a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>Account Financial Report</span>
				</div>
				<div class="box-icons">
					<a class="expand-link">
			...
			<div class="box-content no-padding">			
			  <div style='text-align:center' ng-hide='isMainLoader' class="loading-spiner-holder" data-loading ><div class="loading-spiner"><img src="../common/img/gif1.gif" /></div></div>			
				<form name='finReportForm' action='accfnreportexcel.php' method='POST' novalidate>	
					<div class='row appcont' ng-init="ba='ta'">
						<div class='row appcont col-lg-10 col-xs-12 col-sm-12 com-md-12' ng-init="creteria='BT'"  style="margin-left: 122px;">
					...
					<div class='row appcont'>
						<table show-filter="true"  class="finreport table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							<thead>
								<tr> 
									...
									<th >State</th>
									<th><?php echo FINANCIAL_REPORT_MAIN_TABLE_TOTAL_AMOUNT; ?></th>									
								</tr>
							</thead>
							<tbody id='tbody'>
								 <tr ng-show='tablerow' ng-repeat="x in res">
									...
									<td>{{ x.date }}</td>
									<td ng-show="x.td" style="width: 250px;">{{ x.otype}}</td>
									<td ng-show="x.ad" style="width: 350px;">{{ x.agent }}</td>	
									<td>{{ x.state }}</td>	
									<td >{{ x.toamt }}</td>
								</tr>
