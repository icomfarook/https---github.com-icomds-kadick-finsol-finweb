...
<div ng-controller='ClientTopicCtrl' >
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!clnttop"><?php echo JOUNRAL_ENTRY_COMMI_HEADING1; ?></a></li>
			<li><a href="#!clnttop">Client Topic</a></li>
		</ol>
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>
				<form name='infoViewForm'  action ='' method='POST'>	
                    ...
                    <div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								...
								<input maxlength='100' ng-trim="false" ng-model="IMEI" type='text' id='IMEI' name='IMEI'   class='form-control' required/>
							</div>
                            <div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label>Topic</label>
								<input maxlength='100' ng-trim="false" ng-model="Topic" type='text' id='Topic' name='Topic'   class='form-control'/>
							</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content" >
					<div class="modal-header">
						...
						<h2 style='text-align:center'>Client Topic - Details - {{agent}}</h2>
					</div>	
