...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!upgrade">Group List</a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-content no-padding">	
				...
				<form name='GroupListForm' action='' method='POST'>	
					<div class='row appcont'>
					<div class='row appcont' >	
						<div class='col-lg-12 col-xs-12 col-sm-12 col-md-12' style="width:28%;margin-left:35%">
								<label style="text-align:center;margin-left: 30%;">Agent Name<span ng-show="GroupListForm.agentCode.$touched ||GroupListForm.agentCode.$dirty && GroupListForm.agentCode.$invalid">
								<span class = 'err' ng-show="GroupListForm.agentCode.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div style = 'text-align:Center;margin-top: 2%'; class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>
								<button type="button" class="btn btn-primary" ng-disabled = "GroupListForm.$invalid"  ng-click='GroupListForm.$invalid=true;query()' ng-hide='isHide'  id="Query"><?php echo TSS_ACCOUNT_BUTTON_QUERY; ?></button>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
					<div class="modal-header">
						...
						<h2 style='text-align:center'>Child Agent Details- {{agent_code}}  <span ng-show='parenroutletname'>({{lname}})</span></h2>
	...
	<div id='UpgradeUpdaetDialogue' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-lg" style='width:100%'>
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h2 style='text-align:center'>Upgrade [ {{agent_name}} ]  as Parent</h2>
				</div>	
				<div style='text-align:center' class="loading-spiner-holder" data-loading1 ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif2.gif" /></div></div>
						...
						<div   class='col-xs-12 col-md-12 col-lg-4 col-sm-12 '>
							...
							<div class='row appcont'>				
								...
								<div  class='col-lg-4 col-xs-12 col-sm-12 col-md-12 parenttype'>
									...
									<select ng-disabled = 'isSelectDisabled'  readonly  ng-model="application_id"   name='application_id' id='application_id'  class='form-control'  >
									...
									<div  class='col-lg-4 col-xs-12 col-sm-12 col-md-12 parenttype'>
									<label>Group ID<span class='spanre'>*</span><span class='err' ng-show="ApplicatioTransferDForm.parentcode.$error.required && ApplicatioTransferDForm.parentcode.$invalid"><?php echo REQUIRED;?></span></label>
									<select ng-disabled = 'isSelectDisabled' readonly ng-init="P-Parent"  ng-model="parentcode"  name='parentcode' id='parentcode'  class='form-control'  >
...
$(document).ready(function() {
	...
	$('.dataTables_info').css("display","inline-block"); 	
		$('#datatable-1_paginate').css("display","inline-block");
