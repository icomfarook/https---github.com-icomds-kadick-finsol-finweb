...
<div ng-controller='stateFlexiRateCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!ratflx"><?php echo STATE_MAIN_HEADING1; ?></a></li>
			<li><a href="#!ratflx">Flexi Rate</li>
		</ol>
...
<div class="row">
	<div class="col-xs-12">
		<div class='row'>
			<input type='button' style='float: right;margin-right: 2%;' class='btn btn-primary' value='Create' id='Create'  data-toggle='modal' href='#' data-target='#AddStatFlexiRateDialogue'/>
		
		</div>
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>Flexi Rate</span>
				</div>
				<div class="box-icons">
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
					...
					<tbody>
					 <tr ng-repeat="x in stateflexilist">
						 	<td>{{ x.id }}</td>
							<td>{{ x.state }}</td>
							...
							<td>{{ x.sdate }}</td>
							<td>{{ x.edate }}</td>
							<td><a id={{x.id}} class='editpro' ng-click='edit($index,x.id)' data-toggle='modal' data-target='#EditstateFlexiDialogue'>
			...
			<div id='AddStatFlexiRateDialogue' class='modal ' role='dialog' data-backdrop="static" data-keyboard="false" >
	 <div class="modal-dialog modal-md">
		<div class="modal-content">
			
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h2 style='text-align:center'>State Flexi Rate - Create</h2>
				</div>		
				...
				<form action="" method="POST" name='addstateForm' id="AddstateForm">
				 ...
				 <div class='row' style='padding:0px 15px'>						
					...
					<div class='col-xs-6 col-md-12 col-lg-6 col-sm-12 form_col12_element' >
						<label>Service Feature<span class='spanre'>*</span><span ng-show="addstateForm.servfeature.$touched ||addstateForm.servfeature.$dirty && addstateForm.servfeature.$invalid">
								<span class = 'err' ng-show="addstateForm.servfeature.$error.required"><?php echo REQUIRED;?>.</span></span></label>
								<select ng-model="servfeature" class='form-control' name = 'servfeature' id='servfeature' required >											
					 ...
					 <div class='col-xs-6 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
						...
						<div class='col-xs-6 col-md-12 col-lg-12 col-sm-12 form_col12_element' >
				...
				<div class='modal-footer'>
					...
					<button type='button' class='btn btn-primary' data-dismiss='modal' ng-hide='isHide' ng-click="refresh()"><?php echo STATE_CREATE_BUTTON_CANCEL; ?></a>
	 ...
	 <div id='EditstateFlexiDialogue' class='modal fade' role='dialog' data-backdrop="static" data-keyboard="false" >
		 <div class="modal-dialog modal-md">
			<div class="modal-content">
				
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h2 style='text-align:center'>State Flexi Rate-Edit #{{id}}</h2>
					</div>					 
					...
					<div class='modal-footer ' >
						<button type='button' class='btn btn-primary' data-dismiss='modal' id='Ok' ng-hide='isHideOk' ng-click="refresh()"><?php echo STATE_EDIT_BUTTON_OK; ?></button>
						<button type='button' class='btn btn-primary' data-dismiss='modal' ng-hide='isHide' ng-click="refresh()"><?php echo STATE_EDIT_BUTTON_CANCEL; ?></button>
