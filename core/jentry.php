...
<div ng-controller='jEntryCtrl' data-ng-init="fn_load(<?php echo "'".$partyType."',"."'".$partyCode."'" ?>)">
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!ptyjen"><?php echo JOUNRAL_ENTRY_HEADING2; ?></a></li>
		</ol>
									 ...
									 <div class='row appcont'>
										...
										<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>							
										 ...
										 <div class='clearfix'></div>
											 ...
											 <div  style = 'text-align:Center' class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>
											<button type="button" class="btn btn-primary" ng-disabled = 'infoViewForm.$invalid' ng-click='infoViewForm.$invalid=true;query()' ng-hide='isHide'  id="Query"><?php echo JOUNRAL_ENTRY_MAIN_BUTTON_QUERY; ?></button>
