...
<div ng-controller='NibssCtrl' data-ng-init="fn_load(<?php echo "'".$partyType."',"."'".$partyCode."'" ?>)">
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!andapp">NIBSS POSVAS</a></li>
		</ol>
	...
	<div class="col-xs-12">
		...
		<div class="box">
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>
				<form name='androidappForm' action='nibssexcel.php' method='POST'>	
								 ...
								 <div style = 'text-align:Center'  class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>
								  ...
								  <?php }  if($profileId == 1 || $profileId == 10 || ($profileId >= 20 && $profileId <= 30)) { ?>
									 <div class='row appcont'>
										...
										<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>										
											<label>API Type
											<span ng-show="androidappForm.ApiType.$dirty && androidappForm.ApiType.$invalid">
											<span class = 'err' ng-show="androidappForm.ApiType.$error.required"><?php echo REQUIRED;?></span></span></label>	
											<select  ng-model="ApiType"  type='date' id='ApiType' name='ApiType' required class='form-control' >
										 ...
										 <div class='clearfix'></div>
											 ...
											 <div  style = 'text-align:Center' class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>
											<button type="button" class="btn btn-primary" ng-disabled = 'androidappForm.$invalid' ng-click='query()'   id="Query"><?php echo JOUNRAL_ENTRY_MAIN_BUTTON_QUERY; ?></button>
