...
<div ng-controller='AgtfnReportCtrl'>
<div class="row">
					...
					<div class='row appcont' ng-init="ba='ra'">
						<div class='row appcont col-lg-10 col-xs-12 col-sm-12 com-md-12' ng-init="creteria='BT'">
							...
							<div class='col-lg-2 col-xs-12 col-sm-12 col-md-12' ng-init="creteria='A'">
								...
								<input ng-init= "agentName=<?php echo "'".$partyCode. "-".$agent_name.  "'" ?>"  readonly='true' ng-disabled="agtAgentName" id='agentName'   ng-model='agentName' class='form-control' name='agentName' required />
								</div>	
								 
							 <div class='col-lg-2 col-xs-12 col-sm-12 col-md-12'>
								<label><input type='radio' value='S' ng-model='creteria'/>&nbsp;<?php echo FINANCIAL_REPORT_MAIN_AGENT_SUBAGENT; ?>&nbsp;<input ng-click="impor()" type='checkbox' value='Y' ng-model='subagentdetail'/></label>
						...
						<table show-filter="true" ng-table='' class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							<thead>
								<tr> 
									...
									<th ng-show="agent"><?php echo STATISTICAL_REPORT_MAIN_TABLE_AGENT; ?></th>
									<th ng-show="parent"><?php echo FINANCIAL_REPORT_MAIN_AGENT_PARENT; ?></th>
									<th ng-show="subagent"><?php echo FINANCIAL_REPORT_MAIN_AGENT_SUBAGENT; ?></th>
