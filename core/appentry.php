	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div ng-app="" class="box-content" style='padding: 0px 10px !important;'>	              
				...
				<form name='ApplicationEntryForms' id='ApplicationEntryForms' method='POST' action=''>	
				
					  <div class='rowcontent'>
						<div class='row appcont' style='padding:0px'>
						    <div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_COUNTRY; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.country.$touched ||ApplicationEntryForms.country.$dirty && ApplicationEntryForms.country.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.country.$error.required"></span></span></label>
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_CATEGORY; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.category.$touched ||ApplicationEntryForms.category.$dirty && ApplicationEntryForms.category.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.category.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_APPLIER_TYPE; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.appliertype.$touched ||ApplicationEntryForms.appliertype.$dirty && ApplicationEntryForms.appliertype.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.appliertype.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div ng-show="appliertype=='S'" class='col-lg-3 col-xs-12 col-sm-12 col-md-12 parenttype'>
								<label><?php echo PAYMENT_ENTRY_PARTY_CODE_AGENT; ?><span class='spanre'>*</span><span class='err' ng-show="ApplicationEntryForms.parentcode.$error.required && ApplicationEntryForms.parentcode.$invalid"><?php echo REQUIRED;?></span></label>
							...
							<div ng-show="appliertype=='A'" class='col-lg-3 col-xs-12 col-sm-12 col-md-12 parenttype'>
								<label><?php echo APPLICATION_ENTRY_PARENT_CODE_CHAMPION; ?><span ng-show="ApplicationEntryForms.parentcode.$touched ||ApplicationEntryForms.parentcode.$dirty && ApplicationEntryForms.parentcode.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.parentcode.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div ng-show="appliertype=='A'" class='col-lg-3 col-xs-12 col-sm-12 col-md-12 parenttype'>
								<label><?php echo APPLICATION_ENTRY_PARENT_CODE_CHAMPION; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.parentcode.$touched ||ApplicationEntryForms.parentcode.$dirty && ApplicationEntryForms.parentcode.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.parentcode.$error.required"><?php echo REQUIRED;?></span></span></label>
								<input ng-disabled = 'isSelectDisabled' ng-model="parentcode" type='text' ng-init = "parentcode = '<?php echo $_SESSION['party_code']; ?>'" readonly required class='form-control'/>
							</div>	
							<?php } ?>
						...
						<div class='row appcont'>
							<div class='col-lg-5 col-xs-12 col-sm-12 col-md-12'>
								<label> <?php echo APPLICATION_ENTRY_USER_NAME; ?><span ng-hide = "isMsgSpanD" ng-if="msguser == 'User Name is Available'" style='color:#24b212;padding-left: 10px;'>{{msguser}}</span><span ng-hide = "isMsgSpanD" ng-if="msguser != 'User Name is Available'" style='color:red;padding-left: 10px;'>{{msguser}}</span><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.userName.$touched ||ApplicationEntryForms.userName.$dirty && ApplicationEntryForms.userName.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.userName.$error.required"><?php echo REQUIRED;?></span><span style="color:Red" ng-show="ApplicationEntryForms.userName.$dirty && ApplicationEntryForms.userName.$error.minlength"> <?php echo MIN_10_CHARACTERS_REQUIRED; ?> </span></span></label>
							...
							<div class='col-lg-1 col-xs-12 col-sm-12 col-md-12'><br />
								<button type="button" class="btn btn-primary"  ng-disabled="isGoDisbled"  ng-click='ApplicationEntryForms.$invalid=true;chkuser()' ng-hide='isHideGo'   id="GO">GO</button>
							
							</div>
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo BVN ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.bvn.$dirty && ApplicationEntryForms.bvn.$invalid">
									<span class = 'err'  ng-hide = "isMsgSpan" ng-message="required"><?php echo REQUIRED;?>.</span></span></label><span style="color:Red" ng-show="ApplicationEntryForms.bvn.$dirty && ApplicationEntryForms.bvn.$error.minlength"> <?php echo MIN_11_NUMBERS_REQUIRED; ?> </span>
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_MOBILE_NO; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.mobileno.$dirty && ApplicationEntryForms.mobileno.$invalid">
									<span class = 'err'  ng-hide = "isMsgSpan" ng-message="required"><?php echo REQUIRED;?>.</span></span></label><span style="color:Red" ng-show="ApplicationEntryForms.mobileno.$dirty && ApplicationEntryForms.mobileno.$error.minlength"> <?php echo MIN_11_NUMBERS_REQUIRED; ?> </span>
							...
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo PRE_APPLICATION_ENTRY_FIRST_NAME; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.firstname.$touched || ApplicationEntryForms.firstname.$dirty && ApplicationEntryForms.firstname.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.firstname.$error.required"><?php echo REQUIRED;?><span style="color:Red" ng-show="ApplicationEntryForms.firstname.$dirty && ApplicationEntryForms.firstname.$error.minlength"> <?php echo MIN_4_CHARACTERS_REQUIRED; ?> </span></span></label>
								<input  ng-disabled='isInputDisabled'  ng-model="firstName" spl-char-not type='text'  id='firstname' maxlength='50' name='firstname' ng-minlength="4" required class='form-control'/>
							</div>
							
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo PRE_APPLICATION_ENTRY_LAST_NAME; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.lastname.$touched ||ApplicationEntryForms.lastname.$dirty && ApplicationEntryForms.lastname.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.lastname.$error.required"><?php echo REQUIRED;?><span style="color:Red" ng-show="ApplicationEntryForms.lastname.$dirty && ApplicationEntryForms.lastname.$error.minlength"> <?php echo MIN_4_CHARACTERS_REQUIRED; ?> </span></span></label>
								<input ng-disabled='isInputDisabled'   ng-model="lastName" spl-char-not type='text'  id='lastname' maxlength='50' name='lastname' ng-minlength="4" required class='form-control'/>
							</div>
						...
						<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_STATE; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.state.$touched ||ApplicationEntryForms.state.$dirty && ApplicationEntryForms.state.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.state.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_LOCAL_GOVERMENT; ?><span class='spanre'>*</span><span ng-show="ApplicationEntryForms.localgovernment.$touched ||ApplicationEntryForms.localgovernment.$dirty && ApplicationEntryForms.localgovernment.$invalid">
								<span class = 'err'  ng-hide = "isMsgSpan" ng-show="ApplicationEntryForms.localgovernment.$error.required"><?php echo REQUIRED;?></span></span></label>
							...
							<div ng-model="bvn_validated" class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
							<label ng-show="Success"  style="/* margin-right: 71px; */margin-left: 1px;color: green;margin-top: 5px;"  >BVN Validate Successfully</label><br /><label style="/* margin-right: 71px; */margin-left: 1px;color: red;margin-top: 5px;"   ng-show="Failure">BVN Validate Failure</label><br />
							<button  ng-disabled = "ApplicationEntryForms.$invalid || BVNBtn" type='button'  style='cursor: pointer;margin-top: -9%;margin-left: 49%;'    class='btn btn-primary'  id='prospects_form' ng-click='Getbvn(id)'>BVN Check</button></div>
...
<form name='applicationEntryForm' id='ApplicationEntryForm' method='POST' action=''>	
						...
						<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								...
								<input ng-model="address1" type='text' ng-disabled='BVNCheckForm' spl-char-not  id='Address1' maxlength='50' name='address1' required class='form-control'/>
							</div>
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_ADDRESS2; ?></label>
								<input ng-model="address2" type='text' ng-disabled='BVNCheckForm' id='Address2' maxlength='50' name='address2'  class='form-control'/>
							</div>						
						...
						<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
							<label>Gender <span class='spanre'>*</span><span ng-show="applicationEntryForm.gender.$touched ||applicationEntryForm.gender.$dirty && applicationEntryForm.gender.$invalid">
								...
								<select ng-model="gender"  ng-disabled='BVNCheckForm' class='form-control' name = 'gender' id='gender' required >											
						...
						<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<select   ng-disabled='BVNCheckForm' ng-model='BusinessType'  class='form-control' name = 'BusinessType' id='BusinessType' required>
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<input  ng-model="outletname" spl-char-not type='text' ng-disabled='BVNCheckForm' id='OutLetName' maxlength='50' name='outletname' ng-minlength="4" required class='form-control'/>
							</div>
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<select ng-disabled='BVNCheckForm' ng-model="langpref"   class='form-control' name = 'langpref' id='langpref' required class='form-control'>											
							...
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								...
								<input ng-model="zipcode" type='text' ng-disabled='BVNCheckForm' id='ZipCode' maxlength='15' name='zipcode'  class='form-control'/>
							</div>						
							...
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								...
								<input ng-disabled='BVNCheckForm' ng-model="email" type='email' ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/" id='Email' maxlength='75' required name='email' class='form-control'/>
							</div>
						...
						<div class='row appcont' >
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<input ng-model="taxnumber"  type='text' ng-disabled='BVNCheckForm' id='TaxNumber' maxlength='30' name='taxnumber' class='form-control'/>
							</div>	
							
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_WORK_NO; ?></label>
								<input ng-model="workno" numbers-only  type='text' ng-disabled='BVNCheckForm'  spl-char-not ng-trim="false"  restrict-field="WorkNo" id='WorkNo' maxlength='20' name='workno' class='form-control'/>
							</div>
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<input  ng-disabled='BVNCheckForm' ng-model="Latitude" type='text' ng-pattern="/^(\+|-)?(?:90(?:(?:\.0{1,6})?)|(?:[0-9]|[1-8][0-9])(?:(?:\.[0-9]{1,6})?))$/" id='Latitude' maxlength='15' required name='Latitude' class='form-control'/>
								</div>	
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								...
								<input ng-disabled='BVNCheckForm' ng-model="Longitude" type='text' ng-pattern="/^(\+|-)?(?:180(?:(?:\.0{1,6})?)|(?:[0-9]|[1-9][0-9]|1[0-7][0-9])(?:(?:\.[0-9]{1,6})?))$/" id='Longitude' maxlength='15' required name='Longitude' class='form-control'/>
							</div>
						...
						<div class='row appcont' >
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								...
								<input type='text' ng-disabled='BVNCheckForm' ng-model="cname" id='ContactName' spl-char-not  maxlength='50' name='cname' ng-minlength="4" required class='form-control'  />
							</div>

							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								<label><?php echo APPLICATION_ENTRY_CONTACT_PHONE; ?></label>
								<input ng-model="cmobile"  numbers-only type='text' ng-disabled='BVNCheckForm' id='ContactMobile' maxlength='20' name='cmobile' class='form-control'/>
							</div>
						...
						<div class='row appcont' >
							...
							<div style='display:flex; padding-top: 5px;width:460px'>
								...
								<div ng-disabled='BVNCheckForm' class="fileUpload btn btn-primary" style='bottom:8px;' >
									<span>Upload</span>
						...
						<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
							<label style='margin-left:-2px;'><?php echo "Signature Document"; ?><span class='spanre'>*</span><span style="color:red" ng-show="(applicationEntryForm.attachment3.$touched && applicationEntryForm.attachment2.$error.validFile) ">File is required</span></label>
							<div style='display:flex; padding-top: 5px;width:460px;margin-left:-10px;'>
								<input id="signatureDocument" required placeholder="Choose File"  disabled="disabled" class='form-control' />
								<div ng-disabled='BVNCheckForm' class="fileUpload btn btn-primary" style='bottom:8px;' >
									<span>Upload</span>
									<input type="file" accept="image/jpg,image/jpeg,image/png,application/pdf" valid-file ng-file='uploadfiles3' data-max-size="2097152 " name='attachment3' required  ng-model="attachment3" class="upload" id="attachment3">
								</div>
							</div>
							</div>
						...
						<button type='button' class='btn btn-primary'  ng-click='refresh()' id='Ok' ng-hide='isHideOk' ><?php echo APPLICATION_ENTRY_BUTTON_OK; ?></button>
