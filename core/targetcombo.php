...
<div ng-controller='TargetComboCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!mastarg"><?php echo STATE_MAIN_HEADING1; ?></a></li>
			<li><a href="#!mastarg">Party Target Combo</a></li>
		</ol>
...
<div class="row">
	<div class="col-xs-12">
		<div class='row'>
			<input type='button' style='float: right;margin-right: 2%;' class='btn btn-primary' value='Create Target Combo' id='Create'  data-toggle='modal' href='#' data-target='#AddStateDialogue'/>
		
		</div>
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>Party Target Combo</span>
				</div>
				<div class="box-icons">
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
					...
					<tbody>
					 <tr ng-repeat="x in combolist">
						 	<td>{{ x.id }}</td>
							<td>{{ x.name }}</td>
							<td>{{ x.service_feature }}</td>
							<td>{{ x.active }}</td>
	 ...
	 <div class="modal-dialog modal-md">
		<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h2 style='text-align:center'>Party Target Combo Create</h2>
				</div>		
				...
				<form action="" method="POST" name='addstateForm' id="AddstateForm">
				 ...
				 <div class='row' style='padding:0px 15px'>						
					<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
						<label>Combo Name<span class='spanre'>*</span><span ng-show="addstateForm.name.$touched ||addstateForm.name.$dirty && addstateForm.name.$invalid">
	 ...
	 <div id='EditstateDialogue' class='modal fade' role='dialog' data-backdrop="static" data-keyboard="false" >
		 <div class="modal-dialog modal-md">
			<div class="modal-content">
					...
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h2 style='text-align:center'>Edit Party Target Combo</h2>
					</div>					 
					...
					<div class="modal-body">		
						...
						<div id='countryBody'  ng-hide='isLoader'>						
							<div class='row' style='padding:0px 15px'>
								<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
									<label>Combo Name<span class='spanre'>*</span><span ng-show="editstateForm.name.$touched ||editstateForm.name.$dirty && editstateForm.name.$invalid">
										<span class = 'err' ng-show="editstateForm.name.$error.required"><?php echo REQUIRED;?></span></span></label>
									<input type='text'  ng-model='name' required  name='name' maxlength="20" id='name' class='form-control'/>
								</div>
								
								<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
									<label><?php echo STATE_EDIT_ACTIVE; ?><span class='spanre'>*</span><span ng-show="editstateForm.active.$touched ||editstateForm.active.$dirty && editstateForm.active.$invalid">
