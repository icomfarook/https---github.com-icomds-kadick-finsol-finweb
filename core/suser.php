	...
	<div class="row">
		<div id="breadcrumb" class="col-xs-12">
			...
			<ol class="breadcrumb pull-left">
				<li><a href="#!acssus"><?php echo USER_MAIN_HEADING1; ?></a></li>
				<li><a href="#!acssus"><?php echo USER_MAIN_HEADING2; ?></a></li>
			</ol>
						...
						<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
							<div class='col-lg-12 col-xs-12 col-sm-12 col-md-12' style='text-align: center;padding: 0px;'>
								<?php 
									...
									<input type='button'  class='btn btn-primary' ng-click="sendmail(id)" value='<?php echo USER_MAIN_OTP_SEND_EMAIL_BUTTON; ?>'/>
							</div>
						</div>
						<div class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>						
							<div class='border_row'>
								<p  class='no_margin'><?php echo USER_MAIN_OTP_SECRET_KEY_BUTTON; ?>{{key}}<input type='button'  ng-click="regenerate(id)" class='btn btn-primary' value='<?php echo USER_MAIN_OTP_REGENERATE_BUTTON; ?>'/></p>
							</div>
						</div>
						<div class='row  border_row'>		
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								...
								<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
									<input type='button' id='' class='btn btn-primary' ng-disabled="editUserOtpForm.$invalid " ng-click="updatesotppin(id)"  value='<?php echo USER_MAIN_OTP_PIN_UPDATE_BUTTON; ?>'/>
								</div>
							</div>								
							<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
								<input type='button'  class='btn btn-primary'  ng-click="getcurrentotp(id)" value='<?php echo USER_MAIN_OTP_GET_CURRENT_OTP; ?>'/><label id="CurrentOtp"></label><div id='currmsg'></div>
							</div>
						</div>
...
<!--Edit Dynamic Otp End -->
			<div id='EditSOtp' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
				<div class='modal-dialog'  style='width:70%'>
					<div class='modal-content modal-md'>						
									...
									<table class='table table-bordered'>
										...
										<tr>
											...
											<tr>
												...
												<button type='button' ng-click="EditUserControlForm.$invalid=true;updatesotpvalue(id)" id = '' class='btn btn-primary sotpupdate'><?php echo SUSER_BUTTON_UPDATE; ?></button></div></th>
											</tr>
											<tr>
												...
												<button type='button' ng-click="EditUserControlForm.$invalid=true;updatesotppin(id)" class='btn btn-primary sotppinupdate'><?php echo SUSER_BUTTON_UPDATE; ?></button></div></th>
											</tr>
										</thead>
									</table>
									</form>									
							...
							<div class='col-lg-6 col-xs-12 col-md-12 col-sm-12  border_form border_form_padding1'>
								<div class='row'>							
									...
									<div class='col-lg-6 col-xs-12 col-md-12 col-sm-12 '>
										...
										<div ng-if= "locked==='N'">
											<button type='button'  confirmed-click="lock(id)" ng-confirm-click="Are you sure want to lock User - {{user}}" class='btn btn-danger lock'><?php echo USER_MAIN_CONTORL_LOCK_BUTTON; ?></button>
										</div>{{msg}}
									</div>							
								</div>
								<div class='row'>
					   ...
					   <div class='row'>
						...
						<div class='row'>
							<div class='col-lg-12 col-xs-12 col-md-12 col-sm-12 form_col12_element' style='text-align:center'>
								<button type='button' class='btn btn-primary' ng-disabled="(passwordResetForm.$invalid) || (password !== repassword)" ng-click='uppassreset(id)' ><?php echo USER_MAIN_CONTROL_UPDATE_BUTTON; ?></button>
	...
	<div id='OtpChange' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
		<div class='modal-dialog'>
			<div class='modal-content modal-md'>
					...
					<div class='modal-footer' style='text-align:Center'>
						<input type='button' class='btn btn-primary' ng-click="otytypeupdate(id)" ng-hide='isHide' value='<?php echo USER_MAIN_DYNAMIC_UPDATE_BUTTON; ?>'/>
	...
	<div id='posaccess' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
		<div class='modal-dialog'>
			<div class='modal-content modal-md'>			
					...
					<div class='modal-footer' style='text-align:Center'>
						<input type='button' class='btn btn-primary' confirmed-click="posaccessupdate(id)" ng-confirm-click="Are you sure want to Change Pos access"  ng-hide='isHide' value='<?php echo USER_MAIN_DYNAMIC_UPDATE_BUTTON; ?>'/>
						<input type='button' data-dismiss='modal' class='btn btn-primary' value='<?php echo USER_MAIN_DYNAMIC_CANCEL_BUTTON; ?>' ng-hide='isHideCancel'/>
						<button type='button' class='btn btn-primary' data-dismiss='modal' id='Ok' ng-hide='isHideOk' ><?php echo USER_MAIN_DYNAMIC_OK_BUTTON; ?></button>
					</div>						
			</div>
...
<div id='UserAccsess' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
		<div class='modal-dialog'>
			<div class='modal-content modal-md'>
					...
					<div class='modal-footer' style='text-align:Center'>
						<input type='button' class='btn btn-primary' ng-click="updateaccess(id)" ng-hide='isHide' value='<?php echo USER_MAIN_DYNAMIC_UPDATE_BUTTON; ?>'/>
						<input type='button' data-dismiss='modal' class='btn btn-primary' value='<?php echo USER_MAIN_DYNAMIC_CANCEL_BUTTON; ?>' ng-hide='isHideCancel'/>
						<button type='button' class='btn btn-primary' data-dismiss='modal' id='Ok' ng-hide='isHideOk' ><?php echo USER_MAIN_DYNAMIC_OK_BUTTON; ?></button>
					</div>	
