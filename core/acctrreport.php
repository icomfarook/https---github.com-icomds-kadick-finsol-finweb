...
<div ng-controller='AcctrReportCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!rptacctra"><?php echo TRANSACTION_REPORT_MAIN_HEADING1; ?></a></li>
			<li><a href="#!rptacctra">Account Transaction Report</a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>Account Transaction Report</span>
				</div>
				<div class="box-icons">
					<a class="expand-link">
			...
			<div class="box-content no-padding">			
			  <div style='text-align:center' ng-hide='isMainLoader' class="loading-spiner-holder" data-loading ><div class="loading-spiner"><img src="../common/img/gif1.gif" /></div></div>			
				<form name='trReportForm' action='acctrreprtexcel.php' method='POST' >	
						...
						<table class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							...
							<tbody>
								 <tr ng-show='tablerow' ng-repeat="x in res">
									...
									<td>{{ x.status }}</td>
									<td>{{ x.dtime }}</td>									
									<td><a class='trReportDialogue' ng-click='view(x.id,x.code)' data-toggle='modal' data-target='#trReportviewDialogue'>
			...
			<div class="modal-content">
				<form action="" method="POST" name='trReportDialogueForm' id="trReportDialogueForm">
					<div class="modal-header">
						...
						<h2 style='text-align:center'>Account Service Transaction Report : {{no}}</h2>
					</div>					 
	 ...
	 <div id='trReportviewDialogue' class='modal' id='myModal' role='dialog'>
		<div class="modal-dialog modal-lg" style='width:100%'>
			<div class="modal-content">
