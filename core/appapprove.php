...
<div ng-controller='appApproveCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!appapr"><?php echo APPLICATION_APPROVE_HEADING1; ?></a></li>
			<li><a href="#!appapr"><?php echo APPLICATION_APPROVE_HEADING2; ?></a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span><?php echo APPLICATION_APPROVE_HEADING3; ?></span>
				</div>
				<div class="box-icons">
					<a class="expand-link">
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>			
				<form name='applicationApproveForm' method='POST'>	
					<div class='row appcont'>
						 ...
						 <div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
							<label><?php echo APPLICATION_APPROVE_END_DATE; ?>
								...
								<input  ng-model="endDate" type='date' id='EndDate' ng-blur='checkdate(startDate,endDate)' name='endDate' required class='form-control'/>
						</div>
						<div class='col-lg-6 col-xs-12 col-sm-12 col-md-12'>
							<br/>
							<button type="button" class="btn btn-primary" ng-click='applicationApproveForm.$invalid=true;query()' ng-hide='isHide' ng-disabled = "applicationApproveForm.$invalid"  id="Query"><?php echo APPLICATION_APPROVE_QUERY_BUTTON; ?></button>
							<button type="button" class="btn btn-primary"  ng-click='resetappr()' id="Reset"><?php echo APPLICATION_APPROVE_RESET_BUTTON; ?></button>
						</div>
					</div>
					<div class='row appcont'>
						<table class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							<thead>
								<tr> 
									<th><?php echo APPLICATION_APPROVE_ID; ?></th>
									<th><?php echo APPLICATION_APPROVE_CATEGORY; ?></th>
									<th><?php echo APPLICATION_APPROVE_OUTLET_NAME; ?></th>
									<th><?php echo APPLICATION_APPROVE_APPLIER_TYPE; ?></th>
									<th><?php echo APPLICATION_APPROVE_DATE; ?></th>
									<th><?php echo APPLICATION_APPROVE_STATUS; ?></th>
									<th><?php echo APPLICATION_APPROVE_APPROVE; ?></th>
									<th><?php echo APPLICATION_APPROVE_DETAIL; ?></th>
									<th>Attachments</th>
									<th><?php echo APPLICATION_APPROVE_REJECT; ?></th>
								</tr>
							</thead>
							<tbody>
								 <tr ng-repeat="x in approveList">
									...
									<td>{{ x.time }}</td>
									<td>{{ x.status }}</td>
									<td><a id={{x.id}} class='applicationApproveDialogue' ng-click='edit($index,x.id,x.profile)' data-toggle='modal' data-target='#ApplicationApproveDialogue'>
									...
									<td><a id={{x.id}} class='applicationRejectDialogue' ng-click='openreject($index,x.id,x.name)' data-toggle='modal' data-target='#ApplicationRejectDialogue'>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
					<div class="modal-header">
						...
						<h2 style='text-align:center'><?php echo APPLICATION_APPROVE_APPROVE_HEADING1; ?> - {{outletname}}  <span ng-show='code'>[{{code}} <span ng-show='palogin'> - {{palogin}}</span>]</span></h2>
					</div>	
					...
					<div class='modal-body'>
					 <form action="" method="POST" name='ApplicationApproveDialogue' id="ApplicationApproveDialogue">
						...
						<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
							...
							<div class='row' style='margin-left:0px;margin-right:0px'>
								<fieldset class='scheduler-border'>
									...
									<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 '>
										<label><?php echo APPLICATION_APPROVE_APPROVE_CREDIT_LIMIT; ?><span class='spanre'>*</span><span ng-show="ApplicationApproveDialogue.creditLimit.$dirty && ApplicationApproveDialogue.creditLimit.$invalid">
									...
									<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 '>
										<label><?php echo APPLICATION_APPROVE_APPROVE_DAILY_LIMIT; ?><span class='spanre'>*</span><span ng-show="ApplicationApproveDialogue.dailyLimit.$dirty && ApplicationApproveDialogue.dailyLimit.$invalid">
									<span class = 'err' ng-message="required"><?php echo REQUIRED;?>.</span></span></label>
										<input placeholder='0.00'  numbers-only type='text' class='form-control' name='dailyLimit' ng-model='dailyLimit' required />
									</div>
									
									<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 '>
										<label><?php echo APPLICATION_APPROVE_APPROVE_ADVANCE_AMOUNT; ?><span class='spanre'>*</span><span ng-show="ApplicationApproveDialogue.advanceAmount.$dirty && ApplicationApproveDialogue.advanceAmount.$invalid">
									<span class = 'err' ng-message="required"><?php echo REQUIRED;?>.</span></span></label>
										<input placeholder='0.00'  numbers-only type='text' class='form-control'  name='advanceAmount' ng-model='advanceAmount' required />
									</div>
									
									<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 '>
										<label><?php echo APPLICATION_APPROVE_APPROVE_MINIMUM_BALANCE; ?><span class='spanre'>*</span><span ng-show="ApplicationApproveDialogue.minimumBalance.$dirty && ApplicationApproveDialogue.minimumBalance.$invalid">
									<span class = 'err' ng-message="required"><?php echo REQUIRED;?>.</span></span></label>
							...
							<div class='row' style='margin-left:0px;margin-right:0px'>
								<fieldset class='scheduler-border'>
									<legend class='scheduler-border'><?php echo APPLICATION_APPROVE_APPROVE_SERVICES; ?></legend>
						...
						<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
							...
							<div class='row' >
								<div class='col-xs-12 col-lg-12 col-md-12 col-sm-12'>
									<label><?php echo APPLICATION_APPROVE_APPROVE_COMMENTS; ?><span class='spanre'>*</span><span ng-show="ApplicationApproveDialogue.Comments.$dirty && ApplicationApproveDialogue.Comments.$invalid">
									<span class = 'err' ng-message="required"><?php echo REQUIRED;?>.</span></span></label>
					...
					<div class='modal-footer' ng-hide='isLoader'>					
						...
						<button type='button' class='btn btn-primary' ng-dblclick="false" ng-hide='isHide'  ng-disabled="ApplicationApproveDialogue.$invalid" ng-click="ApplicationApproveDialogue.$invalid=true;approve(id,type)" id="Approve"><?php echo APPLICATION_APPROVE_APPROVE_BUTTON_APPROVE; ?></button>
					</div>
			</div>
		</div>	
	</div>	
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
						...
						<h2 style='text-align:center'><?php echo APPLICATION_APPROVE_REJECT_FORM; ?> - {{name}} </h2>
					</div>		
						<div style='text-align:center' class="loading-spiner-holder" data-loading1 ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif2.gif" /></div></div>
					<div class='modal-body' >
					...
					<div class='modal-footer' ng-hide='isLoader'>				
						<button type='button' class='btn btn-primary' data-dismiss='modal' ng-click='refresh()' id='Ok' ng-hide='isHideOk' ><?php echo APPLICATION_APPROVE_APPROVE_BUTTON_OK; ?></button>
						<button type='button' class='btn btn-primary' data-dismiss='modal' ng-hide='isHide' ><?php echo APPLICATION_APPROVE_APPROVE_BUTTON_CANCEL; ?></button>
					<button type='button' ng-confirm-click="Are you sure want to Reject this Application" class='btn btn-primary' ng-dblclick="false" ng-hide='isHide' ng-disabled="ApplicationRejectDialogue.$invalid"  ng-click="ApplicationRejectDialogue.$invalid=true;reject(id)" id="update"><?php echo APPLICATION_APPROVE_BUTTON_UPDATE; ?></button>
					</div>
					</form>	</div>
						</div>
			</div>
	...
	<div id='ApplicationDetailDialogue' class='modal' role='dialog' data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h2 style='text-align:center'><?php echo APPLICATION_APPROVE_DETAIL_HEADING1;?>- {{outletname}}  <span ng-show='code'>[{{code}} <span ng-show='palogin'> - {{palogin}}</span>]</span></h2>
					</div>		
						<div style='text-align:center' class="loading-spiner-holder" data-loading1 ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif2.gif" /></div></div>
					<div class='modal-body' >
					   <form action="" method="POST" name='applicationDetailForm' id="applicationDetailForm">
						<table class='table table-bordered'>
							<thead>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_ID; ?></th>
									<th>{{id}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_COUNTRY; ?></th>
									<th>{{country}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_NAME; ?></th>
									<th>{{name}}</th>
								</tr>
								<tr>
									<th>First Name</th>
								...
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_APPLIER_TYPE; ?></th>
									<th>{{type}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_APPLICATION_CATEGORY; ?></th>
									<th>{{category}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_DATE; ?></th>
									<th>{{time}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_STATUS; ?></th>
									<th style='color:red'>{{status}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_ADDRESS1; ?></th>
									<th>{{address1}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_ADDRESS2; ?></th>
									<th>{{address2}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_LOCAL_GOVT; ?></th>
									<th>{{localgovt}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_STATE; ?></th>
									<th>{{state}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_ZIPCODE; ?></th>
									<th>{{zip}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_TAX; ?></th>
									<th>{{tax}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_EMAIL; ?></th>
									<th>{{email}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_MOBILE; ?></th>
									<th>{{mobile}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_WORK; ?></th>
									<th>{{work}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_CPM; ?></th>
									<th>{{cpm}}</th>
								</tr>
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_CPN; ?></th>
									<th>{{cpn}}</th>
								</tr>
							<tr>
							...
							<th>{{Longitude}}</th>
								...
								<tr>
									<th><?php echo APPLICATION_APPROVE_DETAIL_COMMENTS; ?></th>
									<th>{{entrycomments}}</th>
								</tr>
							</thead>
						</table>
					...
					<div class='modal-footer'>
					 <button type='button' class='btn btn-primary' data-dismiss='modal' ng-hide='isHide'  href='#'><?php echo APPLICATION_APPROVE_DETAIL_BUTTON_CANCEL; ?></button>
					</div>
				</div>
		</div>
	</div>	
