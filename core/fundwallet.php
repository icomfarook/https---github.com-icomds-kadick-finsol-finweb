...
<div ng-controller='fundWalletCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!appviw">Fund Wallet Report</a></li>
		</ol>
					...
					<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
						...
						<?php  if($profileId == 51 ) { ?>
								<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>												
									...
									<input  readonly = 'true'[(ngModel)] ="partyCode" value = <?php echo "'".$partyCode. "-".$agent_name.  "'" ?> type='text' id='partyCode' name='partyCode'  required class='form-control'/>
								</div>
							<?php }  if($profileId == 50 ) { ?>
								<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>												
									<label>Champion Name<span class='spanre'>*</span>
									<span ng-show="payOutListForm.id.$dirty && payOutListForm.id.$invalid">
									<span class = 'err' ng-show="payOutListForm.id.$error.required"><?php echo REQUIRED;?></span></span></label>
									<input  readonly = 'true'[(ngModel)] ="partyCode" value = <?php echo "'".$partyCode. "-".$agent_name.  "'" ?> type='text' id='partyCode' name='partyCode' required class='form-control'/>
								</div>
						...
						<table class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							...
							<tbody id='tbody'>
								 <tr  ng-repeat="x in fundwalet">
									...
									<td>{{ x.pDate }}</td>
									<td><a id={{x.id}} class='fundwaletDialogue' ng-click='detail($index,x.id)' data-toggle='modal' data-target='#fundwaletDialogue'>
										<button class='icoimg'><img style='height:22px;width:22px' src='../common/images/edit.png' /></button></a></td>
										<td><a  id={{x.id}} class='fundwaletDialogue' ng-click='printwallet(x.id,x.party_code)' data-toggle='modal' >
