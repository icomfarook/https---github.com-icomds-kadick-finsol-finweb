...
<div ng-controller='CashoutUssdCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!bankacc">CashOut USSD Bank</a></li>
		</ol>
...
<div class="row">
	<div class="col-xs-12">
		<div class='row'>
			<input type='button' style='float: right;margin-right: 2%;' class='btn btn-primary' value='Create CashOut USSD Bank' id='Create'  data-toggle='modal' href='#' data-target='#AddBankDialogue'/>
		
		</div>
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>CashOut USSD Bank</span>
				</div>
				<div class="box-icons">
		...
		<div class="modal-dialog modal-lg" style='width:85%'>
			<div class="modal-content">
					<div class="modal-header">
						...
						<h2 style='text-align:center'>CashOut USSD Bank Account Details - {{bankmasterid}}</h2>
					</div>	
					...
					<form action="" method="POST" name='DetailBankDialogue' id="DetailBankDialogue">
						<div id='ApplicationViewBody'>
							...
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label>Bank Name : <span class='labspa'>{{bankmasterid}}</span></label>
							</div>
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label>USSD Code : <span class='labspa'>{{ussdCode}}</span></label>
							</div>
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
	 ...
	 <div class="modal-dialog modal-md">
		<div class="modal-content">
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h2 style='text-align:center'>Create CashOut USSD Bank Details</h2>
				</div>		
				...
				<form action="" method="POST" name='addstateForm' id="AddstateForm">
				 <div  id='CashoutUSSDCreateBody'  ng-hide='isLoader'>
				 <div class='row' style='padding:0px 15px'>						
					...
					<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
						<label>USSD Code<span class='spanre'>*</span><span ng-show="addstateForm.ussdCode.$touched ||addstateForm.ussdCode.$dirty && addstateForm.ussdCode.$invalid">
								<span class = 'err' ng-show="addstateForm.ussdCode.$error.required"><?php echo REQUIRED;?></span></span></label>
						<input type='text' ng-trim="false"   ng-model="ussdCode" name='ussdCode' maxlength="50"  id='ussdCode' required class='form-control'/>
					</div>
					</div>
	 ...
	 <div id='EditBankDialogue' class='modal fade' role='dialog' data-backdrop="static" data-keyboard="false" >
		 <div class="modal-dialog modal-md">
			<div class="modal-content">
					...
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h2 style='text-align:center'>Edit CashOut USSD Bank Details</h2>
					</div>					 
						<div style='text-align:center' class="loading-spiner-holder" data-loading1 ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif2.gif" /></div></div>						 
					<div class="modal-body">		
						<form action="" method="POST" name='editbankForm' id="EditbankForm">
				 <div  id='CashoutUSSDEditBody'  ng-hide='isLoader'>
				<div class='row' style='padding:0px 15px'>						
					<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element' >
					...
					<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
						<label>USSD Code<span class='spanre'>*</span><span ng-show="editbankForm.ussdCode.$touched ||editbankForm.ussdCode.$dirty && editbankForm.ussdCode.$invalid">
								<span class = 'err' ng-show="editbankForm.ussdCode.$error.required"><?php echo REQUIRED;?></span></span></label>
						<input type='text' ng-trim="false"   ng-model="ussdCode" name='ussdCode' maxlength="50"  id='ussdCode' required class='form-control'/>
					</div>
					</div>
					 ...
					 <div class='col-xs-6 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
							<label><?php echo APPLICATION_APPROVE_START_DATE; ?>
							<span class = 'err' ng-show="editbankForm.startDate.$error.required"><?php echo REQUIRED;?></span></span></label>
								<input  ng-model="startdate" type='date' id='startdate' name='startdate'  class='form-control'/>
						</div>
						 <div class='col-xs-6 col-md-12 col-lg-6 col-sm-12 form_col12_element'>
							<label><?php echo APPLICATION_APPROVE_END_DATE; ?>
							<span class = 'err' ng-show="editbankForm.endDate.$error.required"><?php echo REQUIRED;?></span></span></label>
								<input  ng-model="expdate" type='date' id='expdate' name='expdate'  class='form-control'/>
						</div>
						<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element' >
						<label><?php echo STATE_CREATE_ACTIVE; ?> <span class='spanre'>*</span><span ng-show="editbankForm.active.$touched ||editbankForm.active.$dirty && editbankForm.active.$invalid">
