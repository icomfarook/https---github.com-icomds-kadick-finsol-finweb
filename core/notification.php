				...
				<form name='infoViewForm' method='POST'>	
					<div class='row appcont'>						
						 ...
						 <div class='row appcont' ng-init="creteria='A'">
								...
								<label><input value='A' type='radio' name='creteria' ng-model='creteria' /></label>
							...
							<div class='col-lg-2 col-xs-12 col-sm-12 col-md-12'>
								<label><input value='UT' type='radio' name='creteria' ng-model='creteria' /></label>
							...
							<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><input value='STATE' type='radio' name='creteria' ng-model='creteria' /></label>
								...
								<select  ng-model="state" ng-change='statechange(this.state)' ng-init="state='ALL'"  class='form-control' name = 'state' id='state' required ng-disabled="creteria !='STATE' && creteria !='LOCAL_GOVT'">>											
								...
								<div class='col-lg-3 col-xs-12 col-sm-12 col-md-12'>
								<label><input value='LOCAL_GOVT' type='radio' name='creteria' ng-model='creteria' /></label>
