...
<div ng-controller='AccstatReportCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			<li><a href="#!rptaccsta"><?php echo STATISTICAL_REPORT_MAIN_HEADING1; ?></a></li>
			<li><a href="#!rptaccsta">Account Statistical Report</a></li>
		</ol>
	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>Account Statistical Report</span>
				</div>
				<div class="box-icons">
					<a class="expand-link">
			...
			<div class="box-content no-padding">			
			  <div style='text-align:center' ng-hide='isMainLoader' class="loading-spiner-holder" data-loading ><div class="loading-spiner"><img src="../common/img/gif1.gif" /></div></div>			
				<form name='stateReportForm'  action='accstatreprtexcel.php' method='POST' novalidate>	
					...
					<div class='row appcont'>
						<table style="column-width: 100px;" class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							<thead>
								<tr> 
