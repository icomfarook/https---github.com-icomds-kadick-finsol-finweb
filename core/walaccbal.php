...
<div ng-controller='walaccbalCtrl' >
<div class="row">
	...
	<div class="col-xs-12">
		...
		<div class="box">
			...
			<div style='text-align:center' class="loading-spiner-holder"  ng-hide='isMainLoader' data-loading ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif1.gif" /></div></div>
				<form name='infoViewForm' action='wallrptexcel.php' method='POST'>	
					<div class='row appcont'>									
					  <?php  if($profileId == 1 || $profileId == 10 || $profileId == 20 || $profileId == 23 || $profileId == 50 || $profileId == 22 || $profileId == 26) {?>
						 <div class='row appcont'>
							 <div class='  col-lg-2 col-xs-12 col-sm-12 com-md-12'  ng-init="partytype='A'">
						...
						<div class='clearfix'></div>
									<div  style="text-align:Center;margin-top: 10px;" class='col-lg-12 col-xs-12 col-sm-12 col-md-12'>
					...
					<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							...
							<tbody>
								 <tr ng-show='tablerow' ng-repeat="x in res">
									<td><span ng-show="x.partytype=='A'">{{ x.agent_code }}</span><span ng-show="x.partytype=='C'">{{ x.champion_code }}</span></td>
									...
									<td><a id='{{code}}' class='ApplicationViewDialogue' ng-click='view($index,x.agent_code,x.champion_code, x.partytype)' data-toggle='modal' data-target='#ApplicationViewDialogue'>
			...
			<div class="modal-content" ng-repeat="x in resview">
					...
					<form action="" method="POST" name='ApplicatioViewDialgoue' id="ApplicatioViewDialgoue">
						<div id='ApplicationViewBody' >
							...
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
								<label><span ng-show="partycode=='A'">Agent Name :</span><span ng-show="partycode=='C'">Champion Name : </span> 	<span class='labspa' ng-show="partycode=='A'">{{x.agent_name}}</span>
								<span class='labspa' ng-show="partycode=='C'">{{x.champion_name}}</span></label>
							</div>
							<div class='col-lg-4 col-xs-12 col-sm-12 col-md-12'>
