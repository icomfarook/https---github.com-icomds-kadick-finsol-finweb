						...
						<table class="table maintable table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
							<thead>
								<tr> 
									...
									<th ng-show="reportFor=='ALL'">Champion / Agent Name</th>
									<th ng-show="reportFor=='A'"><?php echo TRANSACTION_REPORT_MAIN_TABLE_AGENT_NAME; ?></th>
									<th ng-show="reportFor=='C'">Champion Name</th>
