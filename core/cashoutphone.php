...
<div ng-controller='CashoutPhoneCtrl'>
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		...
		<ol class="breadcrumb pull-left">
			...
			<li><a href="#!bankacc">CashOut Phone Bank</a></li>
		</ol>
...
<div class="row">
	<div class="col-xs-12">
		<div class='row'>
			<input type='button' style='float: right;margin-right: 2%;' class='btn btn-primary' value='Create CashOut Phone Bank' id='Create'  data-toggle='modal' href='#' data-target='#AddBankDialogue'/>
		
		</div>
		<div class="box">
			<div class="box-header">
				<div class="box-name">					
					<span>CashOut Phone Bank</span>
				</div>
				<div class="box-icons">
		...
		<div class="modal-dialog modal-lg" style='width:85%'>
			<div class="modal-content">
					<div class="modal-header">
						...
						<h2 style='text-align:center'>CashOut Phone Bank Account Details - {{bankmasterid}}</h2>
					</div>	
	 ...
	 <div class="modal-dialog modal-md">
		<div class="modal-content">
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h2 style='text-align:center'>Create CashOut Phone Bank Details</h2>
				</div>		
				...
				<form action="" method="POST" name='addstateForm' id="AddstateForm">
				 <div  id='CashoutPhoneCreateBody'  ng-hide='isLoader'>
	 ...
	 <div id='EditBankDialogue' class='modal fade' role='dialog' data-backdrop="static" data-keyboard="false" >
		 <div class="modal-dialog modal-md">
			<div class="modal-content">
					...
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h2 style='text-align:center'>Edit CashOut Phone Bank Details</h2>
					</div>					 
						<div style='text-align:center' class="loading-spiner-holder" data-loading1 ><div class="loading-spiner"><img style='width:20%' align="middle" src="../common/img/gif2.gif" /></div></div>						 
					<div class="modal-body">		
						<form action="" method="POST" name='editbankForm' id="EditbankForm">
				 <div  id='CashoutPhoneEditBody'  ng-hide='isLoader'>
					<div class='row' style='padding:0px 15px'>						
					<div class='col-xs-12 col-md-12 col-lg-6 col-sm-12 form_col12_element' >
