 <?php
	...
	if($action == "getreport") {
		...
		$data = array();
		while ($row = mysqli_fetch_array($result)) {
			$data[] = array("no"=>$row['e_transaction_id'],"request_amount"=>$row['request_amount'],"total_amount"=>$row['total_amount'], "ams_charge"=>$row['ams_charge'],"partner_charge"=>$row['partner_charge'],"other_charge"=>$row['other_charge'],"date_time"=>$row['date_time'],"user"=>$row['user'],"operator_description"=>$row['operator_description'],"opr_plan_desc"=>$row['opr_plan_desc'],"mobile_number"=>$row['mobile_number'],"total_discount"=>$row['total_discount'],"reference_no"=>$row['reference_no'],"service_feature_config_id"=>$row['service_feature_config_id'],"device_id"=>$row['device_id'],"ar_lock"=>$row['ar_lock'],"evd_trans_log_id"=>$row['evd_trans_log_id'],"operator_code"=>$row['operator_code']);           
		}
		echo json_encode($data);
	}
