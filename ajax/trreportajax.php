 <?php
	...
	if($action == "getreport") {
		...
		if($profileid == 1 || $profileid == 10 || $profileid == 24 || $profileid == 22 || $profileid == 20 || $profileid == 23 || $profileid == 26  || $profileid  == 50) {
			...
			if($code =='CIN - Cash In'){
		    		$query = "SELECT a.create_time, a.update_time, a.rrn,  a.order_no, a.fin_trans_log_id1, a.fin_trans_log_id2, a.service_feature_code, a.total_amount,a.request_amount, a.service_charge, a.partner_charge, a.other_charge, g.customer_name, a.mobile_no, a.auth_code, g.reference_no, a.comments, a.create_time, a.create_time, a.update_time, concat(b.user_name,' (',b.first_name,' - ', b.last_name,') ') as user,concat(d.bank_master_id,' - ',d.name) as bank, concat(e.partner_id,' - ',e.partner_name) as partner ,if(a.service_feature_code='CIN','Cash-In (Account)',if(a.service_feature_code='COU','Cash-Out (Account)',if(a.service_feature_code='MP0','Cash-Out (Card)','-'))) as transaction_type,  a.sender_name,if(a.status='I','I-Inprogress',if(a.status='N','N-Name Enqiury',if(a.status='S','S-Success',if(a.status='E','E-Error',if(a.status='T','T-Timeout',if(a.status='G','G-Triggered',if(a.status='R','R-Request Cancel',if(a.status='X','X-Cancelled',if(a.status='O','O-Request Confirm','-'))))))))) as status,a.approver_comments FROM  user b, bank_master d, ams_partner e, agent_info f, fin_request a LEFT JOIN  fin_service_order g  on g.fin_service_order_no = a.order_no   WHERE a.user_id = f.user_id and f.agent_code = '".$_SESSION['party_code']."' and g.partner_id = e.partner_id and g.bank_id = d.bank_master_id and a.user_id = b.user_id and g.fin_service_order_no = a.order_no and a.fin_request_id = $orderNo";
			}else{
				$query = "SELECT a.create_time, a.update_time, a.rrn,  a.order_no, a.fin_trans_log_id1, a.fin_trans_log_id2, a.service_feature_code, a.total_amount,a.request_amount, a.service_charge, a.partner_charge, a.other_charge, g.customer_name, a.mobile_no, a.auth_code, g.reference_no, a.comments, a.create_time, a.create_time, a.update_time, concat(b.user_name,' (',b.first_name,' - ', b.last_name,') ') as user, concat(e.partner_id,' - ',e.partner_name) as partner ,if(a.service_feature_code='CIN','Cash-In (Account)',if(a.service_feature_code='COU','Cash-Out (Account)',if(a.service_feature_code='MP0','Cash-Out (Card)','-'))) as transaction_type,  a.sender_name,if(a.status='I','I-Inprogress',if(a.status='N','N-Name Enqiury',if(a.status='S','S-Success',if(a.status='E','E-Error',if(a.status='T','T-Timeout',if(a.status='G','G-Triggered',if(a.status='R','R-Request Cancel',if(a.status='X','X-Cancelled',if(a.status='O','O-Request Confirm','-'))))))))) as status,a.approver_comments FROM user b,  ams_partner e, agent_info f,fin_request a, fin_trans_log l LEFT JOIN  fin_service_order g  on g.fin_service_order_no = a.order_no   WHERE a.user_id = f.user_id and f.agent_code = '".$_SESSION['party_code']."' and g.partner_id = e.partner_id  and a.user_id = b.user_id and g.fin_service_order_no = a.order_no and a.fin_request_id = $orderNo";
			}
		}
