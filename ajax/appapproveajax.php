<?php
	...
	if($action == "query") {
		...
		if (!$result) {
			...
			$approve = infotableentry($partycatype,$id, $type, $con, $loginname, $createuser, $party_code, $parentType,$SalesParentType,$SalesChainCode,$RefferedBy,$Code);
			if($approve == 0) {
...
//error_log("service". $service);
	...
	function infotableentry($partycatype,$id, $type, $con, $loginname, $createuser, $party_code, $parentType,$SalesParentType,$SalesChainCode,$RefferedBy,$Code) {
