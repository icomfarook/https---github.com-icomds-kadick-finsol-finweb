<?php
	...
	if($action == "query") {
		...
		$insert_query="INSERT into agent_group_account_audit(agent_code,group_id,group_type,create_user,create_time) VALUES('$agent_code',$application_id,'P','$user_id',now()) ";
