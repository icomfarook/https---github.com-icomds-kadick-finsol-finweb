	...
	if($action == "getreport") {
		...
		while ($row = mysqli_fetch_array($result)) {
			$data[] = array("id"=>$row['party_rank_month_id'],"party_type"=>$row['party_type'],"agent_name"=>$row['agent_name'],"run_month"=>$row['run_month'],
						...
						"target_monthly_count"=>$row['target_monthly_count'],
						"target_monthly_amount"=>$row['target_monthly_amount'],
						"actual_iso_daily_count"=>$row['actual_iso_daily_count'],
						"actual_iso_daily_amount"=>$row['actual_iso_daily_amount'],"assigned_rank"=>$row['assigned_party_category_id'],"monthly_rank"=>$row['ranked_party_category_id']);           
		}
